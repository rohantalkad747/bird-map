                ...
                <div className="row">
                    <div className="col-sm-4" >
                        <div className="jumbotron">
                            ...
                            <button className="search-box" id='search-box' style={{backgroundColor: 'black', alignContents: 'center', height: 60, width: 100}}><div style={{color: 'white'}}>Learn more</div></button>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="jumbotron" style={{backgroundColor: '#1a1a1a'}}>
                            ...
                            <div className="container">
                                <button className="search-box" id="search-box" style={{backgroundColor: 'white', alignContents: 'center', height: 60, width: 100, marginTop: 10, marginLeft: '45%', marginRight: '40%'}}><div style={{color: 'black'}}>Donate</div></button>
                            </div>
                        </div>
                    </div>
                </div>
